...
const Home_vue_1 = __importDefault(require("../components/Home.vue"));
...
function __VLS_template() {
    ...
    [Home_vue_1.default,];
    // @ts-ignore
    const __VLS_0 = __VLS_asFunctionalComponent(Home_vue_1.default, new Home_vue_1.default({}));
    const __VLS_1 = __VLS_0({}, ...__VLS_functionalComponentArgsRest(__VLS_0));
    ({}({}));
    const __VLS_4 = __VLS_pickFunctionalComponentCtx(Home_vue_1.default, __VLS_1);
